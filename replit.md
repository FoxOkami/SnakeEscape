...
## Changelog
- July 18, 2025. Doubled pipe thickness in Level 4 - increased flow line width from 4px to 8px and active flow line width from 3px to 6px, plus enlarged glowing dots from 3px to 6px radius
