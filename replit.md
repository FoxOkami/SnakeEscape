...
- July 18, 2025. Fixed key chamber wall removal timing - walls now only removed when fill animation completes at ending tile, not when flow logic reaches ending tile
