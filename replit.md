...
## Changelog
- July 18, 2025. Fixed pipe connections to stay within tile boundaries - added 3-pixel offset from tile edges to prevent lines from extending past boundaries
