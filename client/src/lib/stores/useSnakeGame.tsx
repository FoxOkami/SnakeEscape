...
const PLAYER_SPEED = 0.08; // pixels per second
const WALKING_SPEED = 0.04; // pixels per second when walking (shift held)
const ACCELERATION = 0.4; // pixels per second squared
