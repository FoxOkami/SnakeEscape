...
const PLAYER_SPEED = 0.8; // pixels per second
const WALKING_SPEED = 0.4; // pixels per second when walking (shift held)
const ACCELERATION = 4; // pixels per second squared
